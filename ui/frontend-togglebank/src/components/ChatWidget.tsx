...
const ChatWidget = ({ isOpen, onClose, initialQuery }: ChatWidgetProps) => {
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "assistant",
      content:
        "Hi there! I'm your ToggleBank support assistant. How can I help you with your banking today?",
    },
  ]);
  ...
  const sendMessage = async (text: string) => {
    ...
    setCurrentAgent("Analysing your question...");
    const triageTimer = setTimeout(
      () => setCurrentAgent("Looking up your account details..."),
      2000
    );
    const brandTimer = setTimeout(
      () => setCurrentAgent("Preparing your response..."),
      10000
    );
    ...
    try {
      ...
      if (data.agentFlow.length > 1) {
        ...
        if (specialist) {
          setCurrentAgent(`Finalising with ${specialist.name}...`);
    ...
    <div className="cw-container">
      ...
      <div className="cw-header">
        <div className="cw-header-content">
          <div className="cw-header-text">
            <h2 className="cw-title">ToggleBank Support</h2>
          ...
          if (message.role === "assistant") {
            return (
              <div key={message.id} className="cw-msg-row">
                <div className="cw-msg-avatar">B</div>
      ...
      <form className="cw-footer" onSubmit={handleSubmit}>
        <input
          ...
          type="text"
          className="cw-input"
          placeholder="Ask about your account, payments, loans..."
          value={input}
