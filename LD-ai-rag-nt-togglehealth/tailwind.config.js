  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: (theme) => ({
        ...
        "gradient-health": "linear-gradient(220.23deg, #10B981 -8.97%, #059669 94.12%)",
        ...
        'health-gradient-text-color': 'linear-gradient(220.23deg, #10B981 -8.97%, #059669 94.12%)',
        'bank-gradient-blue-background': 'linear-gradient(178.76deg, #405BFF 1.06%, #7084FF 123.42%)',
        'health-gradient-green-background': 'linear-gradient(178.76deg, #10B981 1.06%, #059669 123.42%)',
      ...
      colors: {
        ...
        healthhomepagebuttongreen: '#10B981',
      },
