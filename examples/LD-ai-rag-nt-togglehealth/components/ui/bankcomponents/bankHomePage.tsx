...
export default function BankHomePage() {
	...
	// Get dynamic assets for banking
	const assets = getIndustryAssets('banking');
	const values = bankHomePageValues(assets);
					...
					<section className="w-full max-w-7xl py-14 sm:py-[8rem] xl:mx-auto flex flex-col sm:flex-row justify-between items-center">
						<div className="flex flex-col text-white w-full sm:w-3/4 xl:w-1/2 justify-start mb-4 pr-0 sm:pr-10 sm:mb-0 gap-y-10 z-10">
							<h1 className="text-5xl sm:text-5xl md:text-6xl lg:text-7xl font-audimat col-span-1 sm:col-span-0 w-full bg-bank-gradient-text-color bg-clip-text text-transparent pr-2 sm:pr-6 md:pr-8 lg:pr-10 xl:pr-8">
								Banking made simple with Toggle Bank
							</h1>
							<p className="text-lg sm:text-md md:text-xl lg:text-xl col-span-2 sm:col-span-0 font-sohnelight w-full text-black pr-6 sm:pr-6 md:pr-8 lg:pr-10 xl:pr-8 ">
								{releaseNewSignUpPromoLDFlag
									? "Sign Up for an account today to receive $500 in free banking!"
									: values.industryMessages}
							</p>
...
const bankHomePageValues = (assets: any) => ({
	name: "ToggleBank",
	industryMessages: "Trusted by millions of customers worldwide",
	bankingServicesArr: [
		{ imgSrc: assets.icons.checking, title: "Checking" },
		{ imgSrc: assets.icons.business, title: "Business" },
		{ imgSrc: assets.icons.credit, title: "Credit" },
		{ imgSrc: assets.icons.mortgage, title: "Mortgage" },
		{ imgSrc: assets.icons.savings, title: "Savings" },
	],
	bankingServicesArrOnHover: [
		{ imgSrc: assets.icons.checkingOnHover, title: "Checking" },
		{ imgSrc: assets.icons.businessOnHover, title: "Business" },
		{ imgSrc: assets.icons.creditOnHover, title: "Credit" },
		{ imgSrc: assets.icons.mortgageOnHover, title: "Mortgage" },
		{ imgSrc: assets.icons.savingsOnHover, title: "Savings" },
	],
});
